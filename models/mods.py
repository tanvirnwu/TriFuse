...
class UVit(nn.Module):
    def __init__(self, config):
        ...
        # Define the U-ViT architecture components
        ...
        self.transformer = nn.Transformer(d_model=128, nhead=4, num_encoder_layers=4, num_decoder_layers=4)
    ...
    def forward(self, x):
        ...
        # Transformer
        b, c, h, w = x.size()
        x = x.view(b, c, h * w).permute(2, 0, 1)  # (seq_len, batch, d_model)
